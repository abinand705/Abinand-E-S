...
- 🗂️ **Showcased Projects & Modal Inspector**:
  - Full-stack tools and applications including **Smart Diagram Studio** (React Flow & Firebase), **Skycast Atlas** (60 FPS canvas weather engine), **FormConnect** (Form API & React Dashboard), **NEO-SPEEDSTER** (Network Telemetry), **MoneyTrack** (Flutter/Firebase Expense Tracker), and **Sci-Calculator** (Android/Kotlin).
