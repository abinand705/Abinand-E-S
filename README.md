...
- 🗂️ **Showcased Projects & Modal Inspector**:
  - Live production work including **ChefCo Hospitality Partners** (B2B Procurement Platform from Kenmerk Softwares internship).
  - Full-stack tools such as **Smart Diagram Studio** (React Flow & Firebase), **Skycast Atlas** (60 FPS canvas weather engine), **NEO-SPEEDSTER**, **Sci-Calculator** (Android/Kotlin), and **Data Pulse Explorer** (Python data analytics).
